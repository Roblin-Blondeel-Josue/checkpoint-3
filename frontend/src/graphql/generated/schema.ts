...
export type AddCountryMutation = { __typename?: 'Mutation', addCountry: { __typename?: 'Country', id: number, code: string, name: string } };
...
export type CountryQuery = { __typename?: 'Query', country: { __typename?: 'Country', id: number, code: string, emoji: string, name: string, continent?: { __typename?: 'Continent', name: string } | null } };
